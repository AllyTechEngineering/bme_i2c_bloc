...
class HeaterService {
  ...
  void heaterServiceUpdateValues(
      {required double setpoint, required double currentTemperature}) {
    _setpoint = setpoint;
    _currentTemperature = currentTemperature;
    debugPrint(
        'Updated values - Setpoint: $_setpoint, Current Temperature: $_currentTemperature');
